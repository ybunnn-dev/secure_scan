...
class SuspiciousFileScannerUI:
    ...
    def setup_files_table_page(self):
        ...
        ttk.Label(left_frame, text="Select Report:", font=self.FONT_NORMAL).pack(side='left')
        
        self.report_cbox = ttk.Combobox(left_frame, state="readonly", font=self.FONT_NORMAL, width=35)
        ...
        ttk.Label(right_frame, text="Search:", font=self.FONT_NORMAL).pack(side='left', padx=(0, 5))
